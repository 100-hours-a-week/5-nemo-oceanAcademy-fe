...
*/
  ...
  const lectures = [
    { classId: 1, name: 'test', bannerImage: bn, instructor: 'chldbsk', category: '프로그래밍' },
    { classId: 2, name: 'data mapping', bannerImage: bn, instructor: 'mia', category: '음악' },
    { classId: 3, name: 'why not?', bannerImage: bn, instructor: 'mui', category: '요리' },
    { classId: 4, name: 'dog angry', bannerImage: bn, instructor: 'meow', category: '미술' },
