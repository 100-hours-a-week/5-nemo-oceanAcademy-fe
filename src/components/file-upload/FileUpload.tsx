...
const FileUpload: React.FC = () => {
  ...
  return (
    <div className={styles.fileUpload}>
      ...
      <button className={styles.uploadButton} onClick={() => document.getElementById('fileInput')?.click()}>사진 등록하기</button>
      <input type="file" id="fileInput" className={styles.fileInput} onChange={handleFileChange} />

      <div className={styles.previewContainer}>
        {preview ? <img src={preview} alt="Preview" className={styles.previewImage} /> : <div className={styles.placeholder}></div>}
      </div>
